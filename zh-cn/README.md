...
- 离线阅读: 推送到GitHub后会触发 travis-ci 的编译，相应的部分编译输出提供七牛的静态文件加速下载。
    ...
    2. PDF. [Gitbook](https://www.gitbook.com/download/pdf/book/yuanbin/algorithm?lang=zh-cn), [简体中文 - 适合打印版](http://docs4bill.qiniudn.com/doc/algorithm_zh-cn_billryan_print.pdf) - 推荐下载七牛的版本，Gitbook 官方使用的中文字体有点问题。
