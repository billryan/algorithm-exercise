...
- 离线阅读: 推送到GitHub后会触发 travis-ci 的编译，相应的部分编译输出提供七牛的静态文件加速下载。
    1. EPUB. [Gitbook](https://www.gitbook.com/download/epub/book/yuanbin/algorithm?lang=zh-cn) - 适合在 iPhone/iPad/MAC 上离线查看，实测效果极好。
    2. PDF. [Gitbook](https://www.gitbook.com/download/pdf/book/yuanbin/algorithm?lang=zh-cn),[简体中文 - 适合电子屏阅读](http://public.yuanbin.me/ebook/algorithm-ebook_zh-cn.pdf), [简体中文 - 适合打印版](http://docs4bill.qiniudn.com/doc/algorithm_zh-cn_billryan_print.pdf) - 推荐下载适合电子屏阅读的版本，Gitbook 官方使用的中文字体有点问题。
    3. MOBI. [Gitbook](https://www.gitbook.com/download/mobi/book/yuanbin/algorithm?lang=zh-cn) - Kindle 专用. 未测试，感觉不适合在 Kindle 上看此类书籍，尽管 Kindle 的屏幕对眼睛很好...
